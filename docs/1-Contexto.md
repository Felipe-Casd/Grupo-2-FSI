...
Este projeto tem como objetivo principal aprendizado e experiência na área de criação de sites e trabalho em equipe, permitindo que os participantes explorem soluções inovadoras, ampliem seus conhecimentos e impactem positivamente o público-alvo. A proposta será conduzida com base na metodologia ágil Scrum, incentivando a colaboração, a adaptação contínua e a entrega incremental de valor ao longo do desenvolvimento.

## Descrição do Projeto

Este projeto tem como objetivo desenvolver um sistema que ajude pequenas
fábricas de roupas a gerenciarem seus materiais e planejar a produção de forma
mais sustentável. A ideia é reduzir os desperdícios e melhorar o uso dos
recursos, tornando o processo mais produtivo para o negócio.
O principal problema que o sistema busca resolver é a falta de controle com a
compra e o uso da matéria-prima, que pode levar a um excesso de estoque e ao
